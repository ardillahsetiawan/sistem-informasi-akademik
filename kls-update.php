...
if(isset($_POST["submit"])){
  ...
  $query = "UPDATE tbl_kls SET nm_kls = '$nm_kls', kode_kls = '$kode_kls' WHERE id_kls = $id_kls";
      ...
      <div class="row pt-2">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 bg-white">
            <h2 class="mt-2">Edit Data Kelas</h2>
            ...
            <div class="mb-5">
              <form method="POST" target="">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="kode_kls" id="kode_kls" value="<?php echo $row_kls["kode_kls"] ?>" placeholder="Kode Kelas" required>
                </div>
                <div class="mb-3">
