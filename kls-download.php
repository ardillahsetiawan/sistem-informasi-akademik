...
<body class="bg-secondary" onload=window.print()>
  <div class="container">
    <div class="row pt-2">
      <div class="col bg-primary py-5">
        <h1 class="text-center">Aplikasi Akademik</h1>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 bg-white">
        ...
        <!-- <a href="kls-lihat.php?id=<?php echo $row_user["id_kls"] ?>" class="btn btn-success" onclick="window.open('kls-download.php')"></a> -->
